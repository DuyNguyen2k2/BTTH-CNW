...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 23, 2023 lúc 03:50 PM
...
--
-- Cắt ngắn bảng trước khi chèn `baiviet`
--
...
CREATE TABLE `tacgia` (
  ...
  `hinh_tgia` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Cắt ngắn bảng trước khi chèn `tacgia`
--
...
--
-- Cắt ngắn bảng trước khi chèn `theloai`
--
